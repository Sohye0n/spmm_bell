...
for type in ${types[@]}; do
    ...
    for i in {1..3}; do
        ...
        # mtx 파일들은 모두 삭제
        rm -f ./data/$type/twoline_col/*.mtx
    done
    ...
    for i in {1..3}; do
        ...
        # mtx 파일들은 모두 삭제
        rm -f ./data/$type/twoline_row/*.mtx
    done
done
